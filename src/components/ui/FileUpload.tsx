...
const FileUploader: React.FC<FileUploaderProps> = ({ value, onChange }) => {
  ...
  return (
    <div
      className={`border-dashed border-2 rounded-md flex flex-col items-center justify-center h-40 w-full ${dragActive ? "border-green-500 bg-base-100" : "border-info bg-neutral"
        }`}
